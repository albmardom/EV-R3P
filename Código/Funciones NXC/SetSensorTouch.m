function SetSensorTouch( ~ )
%SETSENSORTOUCH inicializa el sensor táctil en la entrada indicada
%   SETSENSORTOUCH(input) informa a "input" que el sensor táctil esta conectado a
%   ese puerto. Las constantes que se pueden usar en "input" son
%   las siguientes: 
%   
...
%   See also SENSOR, SENSOR_1, SENSOR_2, SENSOR_3, SENSOR_4
    ...
    assignin('caller', input, 0); % asignamos a la constante el sensor
                                  % conectado
end
