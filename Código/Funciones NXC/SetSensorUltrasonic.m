function SetSensorUltrasonic( ~ )
%SETSENSORULTRASONIC inicializa el sensor de ultrasonico en la entrada indicada
%   SETSENSORULTRASONIC(input) informa a "input" que el sensor ultrasonico
%   está conectado a ese puerto. Las constantes que se pueden usar en "input" son
%   las siguientes: 
%   
...
%   See also SENSORUS
    ...
    assignin('caller', input, 4); % asignamos a la constante el sensor
                                  % conectado
end
